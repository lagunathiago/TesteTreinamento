...
*/
  ...
  it('Se escreve como Presensial')
   ...
   //Clica em Fazer Incrição
        ...
        cy.get('[ng-show="modal.hybridEventsChoice"] .ui-select-container', { timeout: 60000 })
  .should('have.class', 'disabled');

  cy.get('[ng-show="modal.hybridEventsChoice"] > .modal > .content-box-footer > .btn-swipe-accent')
  ...
  .should('contain.text', 'Não há mais vagas presenciais disponíveis');
