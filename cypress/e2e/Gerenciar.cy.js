...
cy.get('[switch="modal.subscribeByFile"] > .modal > :nth-child(2) > .modal-form > .end > .btn-swipe-accent',{timeout:60000})
.should('be.visible')
.click()
