...
cy.contains('.ui-select-choices-row', 'Thiago Laguna')
  ...
  //Clica em pesquisar
  cy.get('.multiselect.ng-dirty > .btn', {timeout: 10000})
  .should('be.visible')
  .click()

//Clica no treinamento: Gerenciar Teste Automação
  cy.contains('.card-title', /^Gerenciar Teste Automação$/, { timeout: 10000 })
  .scrollIntoView()
  .should('be.visible')
  .click({ force: true });
  ...
  //Pesquisa
cy.get('course-not-subscribed-users.ng-isolate-scope > [ng-include=""] > .report-filters > :nth-child(1) > .filters-container > .multiselect > form.ng-valid > .btn',{timeout:10000})
  .should('be.visible')
  .click({ force: true });
...
//clica no iconn box
 cy.get('td.select-checkbox')
  ...
  //Confirma
  cy.contains('button:visible', 'Confirmar', { timeout: 10000 })
  .should('be.visible')
  .click({ force: true });
  ...
  //Pesquisa
  cy.get('button.icon-spyglass:visible', { timeout: 10000 })
  .eq(1)
  .click({ force: true });
...
//clica no iconn box
 cy.get('td.select-checkbox')
  ...
  cy.wait(2000)
    ...
    //Clique no grupo
  cy.contains('Grupo - 2', {timeout:10000})
  .should('be.visible')
  .click()
...
cy.get('td.select-checkbox')
 ...
 it('Pesquisa por Cargo e faz a Matricula', () => {
  ...
  cy.wait(2000)
    ...
    //Clique no cargo
  cy.contains('Analista de Testes JR', {timeout:10000})
  .should('be.visible')
  .click()
...
//Clica em Filtar por arquivo
  cy.get('.mt-5 > .flex > .btn-swipe-accent', { timeout: 10000 })
  .should('be.visible')
  .click({ force: true });
...
it("Filtros de exportação/Não matriculados", () => {
  ...
  .click({force: true})
      ...
      cy.contains('a', 'Não matriculados', { timeout: 10000 })
  .should('be.visible')
  .click()
  ...
  cy.wait(3000)
      ...
      //Copiar
      cy.get('#not-subscribed-table-1476721_wrapper > :nth-child(1) > .dt-buttons > .buttons-copy',{ timeout: 10000 })
      .should("be.visible")
      .click();
      ...
      //Csv
      cy.get('#not-subscribed-table-1476721_wrapper > :nth-child(1) > .dt-buttons > .buttons-csv', { timeout: 10000 })
      .should("be.visible")
      .click();
      ...
      //Pdf
      cy.get('#not-subscribed-table-1476721_wrapper > :nth-child(1) > .dt-buttons > .buttons-pdf', { timeout: 10000 })
      .should("be.visible")
      .click();
      ...
      //Xls
      cy.get('#not-subscribed-table-1476721_wrapper > :nth-child(1) > .dt-buttons > .icon-file-xls', { timeout: 10000 })
      .should("be.visible")
      .click();
  ...
  cy.wait(3000)
       ...
       //Selecionar todos
        cy.get('#not-subscribed-table-1476721_wrapper > :nth-child(1) > .dt-buttons > .buttons-select-all', { timeout: 10000 })
        .should("be.visible")
        .click();
        ...
        //Desmarcar todos
        cy.get('#not-subscribed-table-1476721_wrapper > :nth-child(1) > .dt-buttons > .buttons-select-none', { timeout: 10000 })
        .should("be.visible")
        .click();

      //Imprimir
      cy.get('#not-subscribed-table-1476721_wrapper > :nth-child(1) > .dt-buttons > .buttons-print', { timeout: 10000 })
      .should("be.visible")
      .click();
...
// -----------------Matriculados/Cancelar Matriculas------------------------
  ...
  .type('kaka 1', { force: true });
    ...
    //Pesquisa
  cy.get('.col-sm-12 > [ng-include=""] > .report-filters > :nth-child(1) > .filters-container > .multiselect > form.ng-valid > .btn',{timeout:10000})
  .should('be.visible')
  .click({ force: true });
 ...
 cy.get('td.select-checkbox')
  ...
  //Cancelar Matricula
  cy.contains('button', 'Cancelar matrícula', { timeout: 10000 })
  .should('be.visible')
  .click({ force: true })

  //Escreve
  cy.get('textarea[ng-model="report.cancellationReason"]', { timeout: 10000 })
  .should('be.visible')
  .clear()
  .type('1 Cancelamento realizado via automação Cypress', { force: true });

  //Confirmar
  cy.get('button.btn-swipe-accent:visible', { timeout: 10000 })
  .contains('Confirmar')
  .click({ force: true });
...
it('Pesquisa por E-mail e Cancela a Matricula', () => {
  ...
  cy.wait(4000)
      ...
      //Digita Email
  cy.get('input[ng-model="filter.text"]', { timeout: 10000 })
  .filter(':visible')
...
it('Pesquisa por Login e Cancela a Matricula', () => {
 ...
 cy.get('td.select-checkbox')
  ...
  cy.wait(4000)
    ...
    //Clica em situação
    cy.get('.col-sm-12 > [ng-include=""] > .report-filters > :nth-child(10) > .filters-container > .multiselect', {timeout:10000})
    .should('be.visible')
    .click()
...
cy.get('.ui-select-choices', { timeout: 10000 })
  .should('be.visible');

  //Clica em Concluído
cy.get('.open > .ui-select-choices > :nth-child(6)', { timeout: 10000 })
  .should('be.visible')
  .click({ force: true });
   ...
   it('Verifica se os usuários estão como Concluidos', () => {
      ...
      cy.contains('table tbody tr', 'kaka 1', { timeout: 10000 })
  .within(() => {
    cy.get('td.subscriptionStatusColumn')
      .should('contain', 'Concluído')
   });

     cy.contains('table tbody tr', 'teste0801-1@sharklasers.com', { timeout: 10000 })
  .within(() => {
    cy.get('td.subscriptionStatusColumn')
      .should('contain', 'Concluído')
   });

     cy.contains('table tbody tr', 'teste aut', { timeout: 10000 })
  .within(() => {
    cy.get('td.subscriptionStatusColumn')
      .should('contain', 'Concluído')
     });
...
cy.get('.open > .ui-select-choices > :nth-child(1)', { timeout: 10000 })
 ...
 //Pesquisa
 cy.get(':nth-child(5) > .filters-container > .multiselect > .icon-spyglass', {timeout:10000})
  .should('be.visible')
  .click({force: true})
  ...
  cy.get('td.select-checkbox:visible', { timeout: 10000 })
...
it('Pesquisa por Perfil e Cancela a Matricula', () => {
 ...
 //Pesquisa
  ...
  cy.wait(2000)
    ...
    //Clique na unidade
  cy.contains('.ui-select-choices-row', 'Outro', { timeout: 10000 })
  .should('be.visible')
  .click({ force: true });
...
cy.get('course-not-subscribed-users.ng-isolate-scope > [ng-include=""] > .report-filters > :nth-child(1) > .filters-container > .multiselect > form.ng-valid > .btn',{timeout:10000})
 ...
 cy.get('td.select-checkbox')
  ...
  //Clica em Matricular
  cy.get('button[ng-click="showSubscribeUsers()"]', { timeout: 10000 })
  .should('be.visible')
  .click({ force: true });
...
it('Vai para a aba de Matriculados/concluidos', () => {
 ...
 cy.get('td.select-checkbox')
  ...
  //Concluir Matricula
  cy.contains('button', 'Concluir matrícula(s)', { timeout: 10000 })
  .should('be.visible')
  .click({ force: true })
...
cy.get('.ui-select-choices', { timeout: 10000 })
  ...
  //Clica em Concluído
cy.get('.open > .ui-select-choices > :nth-child(5)', { timeout: 10000 })
  .should('be.visible')
  .click({ force: true });
   ...
   it('Verifica se os usuários estão como Concluidos', () => {
      ...
      cy.contains('table tbody tr', 'Mikaelle Teste', { timeout: 10000 })
  .within(() => {
    cy.get('td.subscriptionStatusColumn')
      .should('contain', 'Concluído')
   });

     cy.contains('table tbody tr', 'name shark', { timeout: 10000 })
  .within(() => {
    cy.get('td.subscriptionStatusColumn')
      .should('contain', 'Concluído')
   });

     cy.contains('table tbody tr', 'Usuário Teste 090425', { timeout: 10000 })
  .within(() => {
    cy.get('td.subscriptionStatusColumn')
      .should('contain', 'Concluído')
     });
...
it('Ativa a fleg => Exibir apenas os melhores resultados de cada usuário', () => {
  ...
  //Clica na Fleg
  cy.get('.col-sm-12 > .checkbox.mb-20 > .icon-checkbox', {timeout:10000})
  .should('be.visible')
  .click()

  //Verifica se apresentou apenas os usuarios concluidos
    cy.contains('table tbody tr', 'Concluído', { timeout: 10000 })
    .first()
    .should('be.visible')
  ...
  cy.wait(2000)
    ...
    //Selecionar todos
        cy.get('#subscribed-table-1476721_wrapper > :nth-child(1) > .dt-buttons > .buttons-select-all', {timeout: 10000})
        .should("be.visible")
        .click();
        ...
        //Desmarcar todos
        cy.get('#subscribed-table-1476721_wrapper > :nth-child(1) > .dt-buttons > .buttons-select-none', {timeout:10000})
        .should("be.visible")
        .click();

  //Selecionar colunas
        cy.get('#subscribed-table-1476721_wrapper > :nth-child(1) > .dt-buttons > .buttons-collection', {timeout:10000})
        .should("be.visible")
        .click();
  ...
  cy.wait(3000)
      ...
      //Copiar
      cy.get('#subscribed-table-1476721_wrapper > :nth-child(1) > .dt-buttons > .buttons-copy', {timeout:10000})
      .should("be.visible")
      .click();
      ...
      //Csv
      cy.get('#subscribed-table-1476721_wrapper > :nth-child(1) > .dt-buttons > .buttons-csv', {timeout:10000})
      .should("be.visible")
      .click();
      ...
      //Pdf
      cy.get('#subscribed-table-1476721_wrapper > :nth-child(1) > .dt-buttons > .buttons-pdf', {timeout:10000})
      .should("be.visible")
      .click();
      ...
      //Xls
      cy.get('#subscribed-table-1476721_wrapper > :nth-child(1) > .dt-buttons > .icon-file-xls', {timeout:10000})
      .should("be.visible")
      .click();
  ...
  .click({force: true})
    ...
    it('Transferir', () => {
      ...
      cy.contains('button', 'Transferir', { timeout: 10000 })
  .first()
  .click({ force: true });
...
cy.get('.modal:visible', { timeout: 10000 })
  ...
  .click({ force: true });
    ...
    //Em andamento
     cy.contains('table tbody tr', '5 5', { timeout: 10000 })
  .within(() => {
    cy.get('td.subscriptionStatusColumn')
   ...
   it('Conversar',() => {
    ...
    //Clica no primeiro Transferir
      cy.contains('button', 'Conversar', { timeout: 10000 })
  .first()
  .click({ force: true });

   //Fecha modal
  cy.get('[switch="modal.manageSubscriptions"] > .modal > .modal-header > .btn',{ timeout: 10000 })
  .should('be.visible')
  .click()
...
cy.get('button.icon-location:visible')
  ...
  cy.wait(3000)
      ...
      cy.contains('button', 'Bloquear', { timeout: 10000 })
  .first()
  .click({ force: true });
  ...
  cy.wait(1000)
    ...
    //Fecha modal
 cy.get('[ng-click="closeBlockSubscriptionsModal()"]', { timeout: 10000 })
  .first()
  .click({ force: true });
   ...
   //Concluir Matricula
  cy.contains('button', 'Emitir certificados', { timeout: 10000 })
  .should('be.visible')
  .click({ force: true })

   //Clica no icon box
  cy.get('.checkbox:visible', { timeout: 10000 })
  .first()
  .click({ force: true });
...
it('Verefica que não tenha o botão de retomar matricula no usuario Cancelado', () => {
  ...
  cy.contains('td.subscriptionStatusColumn', 'Cancelado', { timeout: 10000 })
  .parents('tr')
  .within(() => {
...
it('Matriculados/Concluidos', () => {
 ...
 cy.get('td.select-checkbox')
  ...
  cy.get('button[title="Retomar matrícula"]', { timeout: 10000 })
  .scrollIntoView()
  .should('be.visible')
  .click({ force: true })
...
cy.get('.popover-body:visible')
  ...
  .click({ force: true });
    ...
    cy.wait(3000)
     ...
     cy.contains('td.subscriptionStatusColumn', 'Em andamento', { timeout: 10000 })
  .parents('tr')
  .within(() => {
    cy.contains('Retomar matrícula').should('not.exist')
  })
  ...
  it('Clica no treinamento ', ()=> {
      ...
      //Clica no Treinamento
       cy.contains('.showcase-card-title', 'Gerenciar Teste Automação', { timeout: 10000 })
  .should('be.visible')
  .scrollIntoView()
  .click()
...
//Clica no treinamento: Gerenciar Teste Automação
  ...
  .click({ force: true });
    ...
    cy.contains('table tbody tr', 'thiago teste', { timeout: 10000 })
  .within(() => {
    cy.get('td.subscriptionStatusColumn')
      .should('contain', 'Concluído')
   });
...
cy.log('DEFINA UM PERIODO DA RETOMADA DE MATRICULA')
  ...
  cy.contains('button.btn-swipe-accent:visible', 'Confirmar', { timeout: 10000 })
  .should('be.disabled');
...
cy.contains('h2', 'Retomar matrícula', { timeout: 10000 })
 ...
 //Fecha modal do gerenciar
  ...
  cy.wait(2000)
    ...
    //Clica em relatórios
    cy.get('[title="Relatórios"] > .sideitem', { timeout: 10000 })
        .should('be.visible')
        .click();
          ...
          //Clica em Matriculas
  cy.get('[data-nodeid="56"]', {timeout:10000})
   .should('be.visible')
  .click({ force: true });
  ...
  cy.contains('td.logDetails', 'Retomou a matrícula', { timeout: 10000 })
  .should('be.visible');
...
//Clica no treinamento: Gerenciar Teste Automação
  ...
  //Clica em gerenciar
    ...
    it('Clica em Desempenho', () => {
       ...
       //Clica em Desempenho
      cy.contains('a', 'Desempenho', { timeout: 10000 })
  .should('be.visible')
  .click()
    ...
    it('Modifica o progresso e o desempenho', () => {
      ...
      //Clica em editar
        cy.get(':nth-child(1) > .progressColumn > div > .ml-10', {timeout:10000})
    .should('be.visible')
  .click()
...
cy.get('.modal:visible .box.ng-scope:visible input[type="number"]').eq(1)
  ...
  cy.get('td.progressColumn', { timeout: 10000 })
...
//Clica no treinamento: processo de seleçao
  cy.contains('.card-title', /^processo de seleção teste$/, { timeout: 10000 })
  .scrollIntoView()
  .should('be.visible')
  .click({ force: true });
  ...
  //Clica em gerenciar
   ...
   //Clica em Processo seleçao
      cy.contains('a', 'Processo de seleção', { timeout: 10000 })
  .click({force: true})
  ...
  //Pesquisa
cy.get('[ng-if="auditReport"] > [ng-include=""] > .report-filters > :nth-child(1) > .filters-container > .multiselect > form.ng-valid > .btn', {timeout:10000})
  .should('be.visible')
  .click({ force: true });

  cy.contains('td', 'Thiago suporte', { timeout: 10000 })
  .should('be.visible');
  ...
  .click({ force: true });
   ...
   cy.contains('td', 'thiago teste', { timeout: 10000 })
  .should('be.visible');
...
it('Situação Aprovado/Recusado', () => {
  ...
  //Clica em Situação
  cy.get('[ng-if="auditReport"] > [ng-include=""] > .report-filters > :nth-child(3) > .filters-container > .multiselect', {timeout:10000})
  .should('be.visible')
  .click()
  ...
  //Reprovado
  cy.get('.open > .ui-select-choices > :nth-child(3)', {timeout:10000})
  .should('be.visible')
  .click()

  //Verifica se está escrito o usuario que foi aprovado
   cy.contains('td', 'teste aut', { timeout: 10000 })
  .should('be.visible');
  ...
  cy.contains('td', 'Thiago suporte', { timeout: 10000 }).should('be.visible');
...
it("Filtros de exportação/Não matriculados", () => {
  ...
  //Selecionar colunas
        cy.get('#audit-table_wrapper > :nth-child(1) > .dt-buttons > .buttons-collection', {timeout:10000})
        .should("be.visible")
        .click();
  ...
  cy.wait(3000)
      ...
      //Copiar
      cy.get('#audit-table_wrapper > :nth-child(1) > .dt-buttons > .buttons-copy',{timeout:10000})
      .should("be.visible")
      .click();
      ...
      //Csv
      cy.get('#audit-table_wrapper > :nth-child(1) > .dt-buttons > .buttons-csv',{timeout:10000})
      .should("be.visible")
      .click();
      ...
      //Pdf
      cy.get('#audit-table_wrapper > :nth-child(1) > .dt-buttons > .buttons-pdf',{timeout:10000})
      .should("be.visible")
      .click();
      ...
      //Xls
      cy.get('#audit-table_wrapper > :nth-child(1) > .dt-buttons > .icon-file-xls', {timeout:10000})
      .should("be.visible")
      .click();
  ...
  .click()
      ...
      //Imprimir
      cy.get('#audit-table_wrapper > :nth-child(1) > .dt-buttons > .buttons-print', {timeout:10000})
      .should("be.visible")
      .click();
...
it('Listagem', () => {
  ...
  cy.get('[name="audit-table_length"]', { timeout: 10000 })
  .select('10');
  ...
  it('Clica no treinamento ', ()=> {
      ...
      //Clica no Treinamento
       cy.contains('.showcase-card-title', 'processo de seleção teste', { timeout: 10000 })
  .should('be.visible')
  .scrollIntoView()
  .click()
...
cy.get('.modal:visible', { timeout: 20000 })
  ...
  cy.wait(5000)
    ...
    cy.get('button[title="Notificações"]', { timeout: 10000 })
  .should('be.visible')
  .click();

  //Clica em visualizar nos documento
  cy.get(':nth-child(1) > .approval-box > .column > .approval-buttons > .btn-swipe-accent', { timeout: 10000 })
  .should('be.visible')
  .click();

  //Recusa o primeiro documento
  cy.get('tbody > :nth-child(1) > :nth-child(9) > .btn', {timeout:10000})
  .should('be.visible')
  .click()
...
//Clica no treinamento: processo de seleçao
  ...
  .click({force: true})
      ...
      cy.contains('tr', 'teste teste', { timeout: 10000 })
  .within(() => {
